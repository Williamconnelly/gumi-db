...
const logger: Logger = new Logger('CollectCharacterIds');
...
function collectCharacterIds(): void {
  ...
  fs.writeFileSync(OUTPUT_PATHS.CHARACTER_IDS_FILE, JSON.stringify([...ids], null, 2), 'utf-8');
  logger.info(`Collected ${ids.size} unique character IDs`);
}
